            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="<?php echo base_url(session('group_name').'/UploadTripulacion')?>"
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Lista Pasajeros <span style='color:red;'>(Busque el pasajaro y
                                    solicite el servicio)</span></h3>
                            <br>Lista de pasajeros, seleccione un pasajero al cual le creara un servicio.
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="tableUsers" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=site_url('admin/SolicitudesTripulacion/'.$pasajero['id_pasajero']);?>"
