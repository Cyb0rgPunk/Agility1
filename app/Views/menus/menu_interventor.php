               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="<?= base_url('admin/Pasajeros')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Pasajeros</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url('admin/CentroCostos')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cargar Centros de Costo</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url('admin/Tarifas')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cargar Tarifas</p>
                              </a>
                          </li>
                  ...
                  <!--li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="<?= site_url('admin/Solicitar')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                          ...
                          <li class="nav-item">
                              <a href="<?= site_url('admin/Historico')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Historico</p>
                              </a>
                          </li>
