               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="<?= base_url('admin/Moviles')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Moviles</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url(session('group_name').'/AddConductor')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Coductores</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url(session('group_name').'/Pasajeros')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Pasajeros</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url(session('group_name').'/CentroCostos')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cargar Centros de Costo</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url(session('group_name').'/Tarifas')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cargar Tarifas</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= base_url(session('group_name').'/SubZonas')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cargar Sub Zonas</p>
                              </a>
                          </li>
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="<?= site_url('admin/SolicitarTripulacion')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="<?= site_url('admin/SolicitarVoucher')?>" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="<?= site_url('admin/RutasRecogidas')?>" class="nav-link">
                                  <i class="nav-icon fa fa-share"></i>
                                  <p>Recogidas</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?= site_url('admin/RutasReparto')?>" class="nav-link">
                  ...
                  <!--li class="nav-item">
                      <a href="<?= base_url('admin/CargarRutas')?>" class="nav-link">
