...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-2 p-2">
            <button type="button" class="btn btn-block btn-primary" onclick="location.href='<?= site_url('admin/RutasReparto')?>'" >Rurtas Reparto</button>
        </div>   
    </div>
    <div class="col-md-12">
        <?php if(session('msg')):?>
    ...
    <div class="row">
        <?php //dd($ruta)?>
        <form action="<?= site_url(session('group_name').'/AsistenciaRutaReparto'); ?>" method="POST">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <input type="hidden" name="abordaron[]" id="cc_pasajeros">
                        <input type="hidden" name="id_ruta" value="<?= $id_ruta;?>">
                        <input type="hidden" name="hora_recogida" value="<?= $hora_recogida;?>">
                        <input type="hidden" name="fecha" value="<?= $fecha;?>">
                        <button id="send" type="" class="btn btn-danger">Finalizar Recorrido</button>
                    </div>
                    <!-- /.card-body -->
                </div>
            </div>
