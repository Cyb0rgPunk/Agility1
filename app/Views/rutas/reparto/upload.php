...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Gestion rutas reparto</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item active">Gestion rutas reparto</li>
            </ol>
        </div>
    </div>
    <div class="row" style="display:<?=$display;?>">
        <div class="col-sm-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="<?php echo base_url(session('group_name').'/CargaRutasReparto')?>"
    ...
    <div class="row" style="display:<?=$display;?>">
        <div class="col-sm-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="<?php echo base_url(session('group_name').'/FiltroFechasReparto')?>"
                    enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-8">
                                <button type="button" class="btn btn-block btn-success" onclick="location.href='<?= site_url(session('group_name').'/RutasReparto/1')?>'" >Todos los registros</button>
                            </div> 
                            <div class="col-sm-2"></div>
                            <div class="col-sm-6">
                                <div class="form-group">
