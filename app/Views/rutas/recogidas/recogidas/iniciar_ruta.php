...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-2 p-2">
            <button type="button" class="btn btn-block btn-primary" onclick="location.href='<?= site_url('admin/RutasRecogidas')?>'" >Recogidas</button>
        </div>   
    </div>
    <div class="col-md-12">
        <?php if(session('msg')):?>
    ...
    <div class="row">
        <?php //dd($ruta)?>
        <form action="<?= site_url(session('group_name').'/AsistenciaRutaRecogida'); ?>" method="POST">
