        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Hisotrial Solicitudes</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color:<?= $color;?>;">
                                ...
                                <td id="evaluate">
                                    ...
                                    <a href="<?=site_url('admin/CancelarSolicitud/'.$solicitudes[$i]['id_solicitud']);?>"
...
function detalles() {
    ...
    $(document).delegate("#btnDetalles", "click", function() {
        ...
        ruta = "<?= base_url(session('group_name').'/GetDetalles/');?>/"
