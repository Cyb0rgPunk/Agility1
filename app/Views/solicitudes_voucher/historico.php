...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Solicitudes Voucher</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo base_url('/')?>">Home</a></li>
                <li class="breadcrumb-item active">Solicitudes Voucher</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Historial Solicitudes Voucher</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    ->where(['ta.id_solicitud'=>$solicitudes[$i]['id_solicitud'], 'ta.solicita'=>'voucher'])
                                ...
                                <td id="evaluate">
                                    ...
                                    <a href="<?=site_url('admin/AsignarMovilVoucher/'.$solicitudes[$i]['id_solicitud']);?>"
                                        class="btn btn-primary" type="button">Asignar movil</a>
                                    <a href="<?=site_url('admin/TarifaAdicional/'.$solicitudes[$i]['id_solicitud'].'/voucher');?>"
                                    ...
                                    <a href="<?=site_url('admin/CancelarSolicitudVoucher/'.$solicitudes[$i]['id_solicitud']);?>"
                                            ...
                                            <div class="card card-outline card-success rounded">
                                                ...
                                                <div class="card-body border border-dark rounded"
                                                    ...
                                                    <div class="row border border-dark">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="text-center">Voucher</label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <span id="detalles_vuelo"></span>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="text-center">Radicado</label>
                                                        </div>
                                                        <div class="col-md-6">
...
function detalles() {
    ...
    $(document).delegate("#btnDetalles", "click", function() {
        ...
        ruta = "<?= base_url(session('group_name').'/GetDetallesVoucher/');?>/"
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response['solicitudes'][0]['id_novedad'] == null){
                    $("#detalles_novedades_viaje").text('Sin novead aún')
                }else{
                    $("#detalles_novedades_viaje").text('Sin novead aún')
                    //$("#detalles_novedades_viaje").text(response['solicitudes'][0]['emailc'])
                } 
