...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form method="POST" action="<?= site_url('admin/SaveSolicitudVoucher')?>">
                ...
                <div class="card card-primary"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="id_nacional">Documento / Identifiación </label>
                                    <input id="id_nacional" class="form-control" type="text" name="id_nacional"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="motivo">Motivo del servicio</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="codigo">CECO</label>
                                    <input type="ceco" class="form-control" name='ceco'
                                        onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                                </div>
                                <!--div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="viaje">Viaje en servicio</label>
